...
class StartsWithAsserter(private val expected: String) : Asserter<String> {
...
class ContainsAsserter(private val expected: String) : Asserter<String> {
    override fun assertValue(t: String) {
...
class EndsWithAsserter(private val expected: String) : Asserter<String> {
    override fun assertValue(t: String) {
